...
export const PROJECTS: Project[] = [
  {
    ...
    imageUrl: "/images/urbanpulse.png",
  ...
  },
  {
    ...
    imageUrl: "/images/stateofgrace.png",
    createdAt: '2025-11-24'
  },
  {
  id: '5',
  title: 'FutureTech Company',
  description: 'A concept product website for a fictional technology company showcasing a modern smartphone and its key features.',
  fullDescription: 'Overview: FutureTech is a concept website created for a fictional technology company that designs and manufactures innovative smartphones. The project focuses on presenting a modern product marketing experience that highlights the device’s key features, design qualities, and overall value through a clean, visually engaging interface.\n\nProblem: Many product websites struggle to communicate complex technical features in a way that is both visually appealing and easy for users to understand. This project explores how thoughtful UX/UI design can simplify product information while still maintaining a strong, engaging brand presence.\n\nProcess: I followed the UX/UI design cycle, beginning with initial sketches and low-fidelity wireframes to establish layout structure and content hierarchy. I then created high-fidelity prototypes to refine the visual design, user interactions, and overall user flow. The site was designed to emphasize product storytelling through feature highlights, clear navigation, and structured sections that guide users through the device’s capabilities and user testimonials.\n\nSolution & Impact: The final website functions as a fully deployed product showcase that demonstrates my ability to move through the complete design process—from ideation and wireframing to prototyping and deployment—while creating a user-centered product experience that effectively communicates both brand identity and product value.\n\nLive Website: https://futuretechproject.vercel.app',
  category: 'Web Development',
  imageUrl: "/images/FutureTechProject.png",
